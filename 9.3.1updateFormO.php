...
<?php 
    ...
    $query = "SELECT * FROM restaurant_owner where restaurantOwnerID = '$idUrl' ";
    ...
    $password = $row["restaurantOwnerPass"];
...
<html>
    <head>
        ...
        <title>Update Restaurant Owner-Admin</title>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <center>
                ...
                <form action="9.3.2updateO.php" method="post">
                    <table>
                        <tr>
                            <td>
