...
<?php 
    ...
    $query = "SELECT * FROM rider where riderID = '$idUrl' ";
    $result = mysqli_query($conn,$query)or die ("Could not execute query in edit.php");
    $row = mysqli_fetch_assoc($result);

    $id = $row["riderID"];
    $name = $row["riderUname"];
    $password = $row["riderPass"];
    $phone = $row["riderPhoneNo"];
?>
...
<html>
    <head>
        ...
        <title>Update Rider-Admin</title>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <center>
                ...
                <form action="9.2.2updateR.php" method="post">
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="phone" id="phone" value="<?php echo $phone?>" required class="textbox">
                            </td>
                        </tr>
